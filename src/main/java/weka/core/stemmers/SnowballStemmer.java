...
package src.main.java.weka.core.stemmers;
...
public class SnowballStemmer 
  ...
  public String stem(String word) {
    ...
    if (m_Stemmer == null) {
      ...
      try {
        // set word
        String[] overRideList = {"ad", "ads" }; 
        boolean overRide = false;
       
        for (String s : overRideList) {
            if (word == s){ 
                overRide = true;
                result = s; 
            } 
        ...
        if (!overRide){ 
            ...
            // get word
            args   = new Object[0];
            //Insert here the list of if statements, the cleanest way to do this would be to read in a file. 
