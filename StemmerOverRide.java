...
public class StemmerOverRide
  implements Stemmer, TechnicalInformationHandler {
  //FROM RACHEL: the words not to stem 
  private String[] stemExceptions = {""}; //defult is null;
  /** for serialization */
  ...
  static {
    ...
    /**
     * Rachel's overRide: Constructor that takes a list of String Exceptions
     *
     * @param  s    an array of exceptions, words that shoudl not be stemmed 
     * @return     a stemmer object 
     */
    public StemmerOverRide(String[] s)
    {
        stemExceptions = s ;
    }
    
    /**
     * Defualt constructor for the StemmerOverRide class, uses no stem exceptions 
     */
    public StemmerOverRide(){ 
        String[] s = {""}; 
        stemExceptions = s;
    }
